...
public class GuiPermCard extends GuiScreen {
	...
	public void drawScreen(int par1, int par2, float par3) {
		...
		fontRendererObj.drawString(I18n.translateToLocal("peripheralsplusplus.inv.permCard"), x + 22, y + 5, 0x313131);
		fontRendererObj.drawString(I18n.translateToLocal("peripheralsplusplus.inv.permCard.perms"), x + 32, y + 20, 0x313131);
		fontRendererObj.drawString(I18n.translateToLocal("peripheralsplusplus.inv.permCard.get"), x + 25, y + 40, 0x313131);
		fontRendererObj.drawString(I18n.translateToLocal("peripheralsplusplus.inv.permCard.withdraw"), x + 25, y + 60, 0x313131);
		fontRendererObj.drawString(I18n.translateToLocal("peripheralsplusplus.inv.permCard.deposit"), x + 25, y + 80, 0x313131);
	}
